...
class LibraryServiceImplTest {
    ...
    void getBookById() {
        ...
        when(bookRepositoryMock.findById(anyString())).thenReturn(expected);
    ...
    void saveBook() {
        ...
        when(authorRepositoryMock.findById(anyString())).thenReturn(testAuthor);
        when(genreRepositoryMock.findById(anyString())).thenReturn(testGenre);
    ...
    void getGenreById() {
        ...
        when(genreRepositoryMock.findById(anyString())).thenReturn(expected);
    ...
    void getAuthorById() {
        ...
        when(authorRepositoryMock.findById(anyString())).thenReturn(expected);
    ...
    void saveComment() {
        ...
        when(bookRepositoryMock.findById(anyString())).thenReturn(Optional.of(book1));
    ...
    void getCommentById() {
        ...
        when(commentRepositoryMock.findById(anyString())).thenReturn(expected);
    ...
    void getCommentsByBookId() {
        Comment comment1 = new Comment("1", "TEST", new Book());
        Comment comment2 = new Comment("2", "TEST2", new Book());
        when(commentRepositoryMock.findByBookId(Mockito.anyString())).thenReturn(List.of(comment1, comment2));
